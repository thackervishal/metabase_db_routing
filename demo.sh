...
# ── STEP 2: admin sets tenant_db = tenant-a (no JWT, no SSO) ─────────────────

echo ""
echo "──────────────────────────────────────────────────────────"
echo ">>> STEP 2: Admin sets Alice's 'tenant_db' attribute to 'tenant-a'"
echo "    (Using PUT /api/user/$ALICE_ID — no JWT involved)"
echo "──────────────────────────────────────────────────────────"
...
echo "    (Same API call, different value — still no JWT)"
echo "──────────────────────────────────────────────────────────"
...
echo "  No JWT. No SSO. Attribute was set directly via Admin API."
echo "============================================================"
